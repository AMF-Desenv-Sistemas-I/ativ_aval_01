...
function somar(...numeros) {
    const soma = numeros.reduce((acumulador, numero) => acumulador + numero, 0); //o reduce é usado para somar todos os elementos
    return soma;
}
...
function calcularMedia(...numeros) {
    ...
    return total / numeros.length;     //soma todos os elementos e divide pelo numero de elementos da lista
}
...
function adicionarPropriedades(objeto, ...novasPropriedades) {
    return Object.assign({}, objeto, ...novasPropriedades); //limpa as chaves dos objetos cidade e profissao
}
